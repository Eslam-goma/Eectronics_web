...
if(isset($_POST['submit'])){
   ...
   $cpass = mysqli_real_escape_string($mysqli, md5($_POST['cpassword']));

   $select = mysqli_query($mysqli, "SELECT * FROM `user_info` WHERE email = '$email' AND password = '$pass'") or die('query failed');
...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      <p>هل لديك حساب؟ <a href="card.php"> تسجيل دخول</a></p>
   </form>
